...
sixteen verbs on every surface.

The service is defined in protobuf, of course:
`ai.pipestream.protomolt.v1.ProtoMoltService`, sixteen typed RPCs in
...
`GET /openapi.json` documents all sixteen operations with schemas derived
