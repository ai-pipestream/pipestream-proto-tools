...
twenty verbs on every surface.

The service is defined in protobuf, of course:
`ai.pipestream.protomolt.v1.ProtoMoltService`, twenty typed RPCs in
...
`GET /openapi.json` documents all twenty operations with schemas derived
